    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: ".625rem" }}>
        <Link
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.borderColor = "#C9973A44";
            (e.currentTarget as HTMLElement).style.color = "#C9973A";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLElement).style.borderColor = "#1E1E2E";
            (e.currentTarget as HTMLElement).style.color = "#8A8498";
          }}
        >
          تسجيل الدخول
        </Link>
        ...
        <Link
          ...
          style={{
            ...
            fontWeight: 700,
            textDecoration: "none",
            boxShadow: "0 4px 16px #C9973A28",
            transition: "all .2s",
            display: "inline-block",
          }}
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.background = "#D4A84A";
            (e.currentTarget as HTMLElement).style.transform =
              "translateY(-1px)";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLElement).style.background = "#C9973A";
