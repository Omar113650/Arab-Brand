...
//     // On dashboard, render only the language toggle
//     return (
...
//             letterSpacing: ".3px",
//             transition: "all .25s",
//             boxShadow: "0 2px 12px rgba(201,151,58,.15)",
//           }}
//           onMouseEnter={e => (e.currentTarget.style.borderColor = "rgba(201,151,58,.7)")}
//           onMouseLeave={e => (e.currentTarget.style.borderColor = "rgba(201,151,58,.35)")}
//         >
//           <span style={{ fontSize: "1rem" }}>{i18n.language === "ar" ? "🇺🇸" : "🇸🇦"}</span>
...
//     ["how", "#how", t("nav.how")],
//     ["clients", "#clients", t("nav.clients")],
//     ["news", "#news", t("nav.news")],
//     ["about", "#about", t("nav.about")],
//     ["contact", "#contact", t("nav.contact")],
//     ["pricing", "#pricing", t("nav.pricing")],
//   ] as const;
...
//             }}
//           >
//             <span style={{ fontSize: "1rem", lineHeight: 1 }}>{i18n.language === "ar" ? "🇺🇸" : "🇸🇦"}</span>
//             <span style={{ fontWeight: 700 }}>{i18n.language === "ar" ? "EN" : "ع"}</span>
//           </button>
//           <Link
//             to="/login"
//             style={{
