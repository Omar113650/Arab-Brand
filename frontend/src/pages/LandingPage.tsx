...
// const FEATURES = [
//   { title:"لوجو SVG احترافي",   desc:"لوجو مخصص قابل للتعديل والتكبير بدون فقدان جودة" },
//   { title:"هوية بصرية كاملة",   desc:"لوحة ألوان وخطوط واستراتيجية بصرية متكاملة" },
//   { title:"محتوى سوشيال ميديا", desc:"منشورات Instagram و TikTok و Twitter جاهزة للنشر" },
//   { title:"Landing Page",        desc:"صفحة هبوط HTML كاملة جاهزة للرفع فوراً" },
//   { title:"بوشير احترافي",       desc:"بروشور البراند جاهز للطباعة والمشاركة" },
//   { title:"Brand Score",         desc:"تقييم شامل لقوة البراند في السوق العربي" },
// ];
...
// // براندات حقيقية اتولّدت بالفعل
// const REAL_BRANDS = [
//   { name: "نخبة كافيه", category: "مطاعم وكافيهات", color: "#C9813A" },
//   { name: "تك ستور",   category: "إلكترونيات",      color: "#1A56DB" },
//   { name: "هيلث بلاس", category: "صحة ولياقة",      color: "#0E9F6E" },
//   { name: "مودا شوب",  category: "أزياء وموضة",     color: "#9333EA" },
//   { name: "بلد كلين",  category: "خدمات تنظيف",     color: "#0891B2" },
//   { name: "ستار أكاد", category: "تعليم وتدريب",    color: "#D97706" },
// ];
...
//     yearlyPrice: "55",
//     period: "شهرياً",
//     yearlyNote: "توفّر $288 سنوياً",
//     color: "#7C3AED",
//     badge: "للشركات",
//     features: [
//       "براندات غير محدودة",
//       "لوجو SVG + AI Variations",
//       "هوية بصرية موسّعة",
//       "Brand Score + تقرير PDF",
//       "محتوى سوشيال (30 منشور/شهر)",
//       "Landing Page متعددة",
//       "بوشير + كتالوج",
//       "Export ZIP",
//       "White Label",
...
//           <h2 style={{ fontFamily:"Sora,sans-serif", fontSize:"clamp(1.5rem,3vw,2rem)", fontWeight:700, color:"#F0EDE6", letterSpacing:"-1px" }}>مشاريع حقيقية بنت هويتها معنا</h2>
//         </div>
//         <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))", gap:".625rem" }}>
//           {REAL_BRANDS.map((b,i)=>(
//             <div key={i} style={{
//               background:"#0E0E1A",
...
//               transition:"all .25s",
//             }}
//             onMouseEnter={e=>{ const el=e.currentTarget; el.style.background="#13131E"; el.style.transform="translateY(-2px)"; }}
//             onMouseLeave={e=>{ const el=e.currentTarget; el.style.background="#0E0E1A"; el.style.transform="translateY(0)"; }}
//             >
//               <div>
//                 <div style={{ fontFamily:"Sora,sans-serif", fontWeight:700, fontSize:".92rem", color:"#F0EDE6", marginBottom:".2rem" }}>{b.name}</div>
//                 <div style={{ fontSize:".72rem", color:"#3A3650" }}>{b.category}</div>
//               </div>
//               <div style={{ padding:".15rem .5rem", borderRadius:6, background:"#C9973A11", border:"1px solid #C9973A22", fontSize:".6rem", color:"#C9973A", fontWeight:700, letterSpacing:".5px", flexShrink:0 }}>AI ✦</div>
//             </div>
//           ))}
//         </div>
//       </section>
...
//       {/* ── PRICING ── */}
//       <section id="pricing" style={{ padding:"5rem 1.5rem", maxWidth:860, margin:"0 auto" }}>
...
//                   color: billing===cycle ? "#08080F" : "#8A8498",
//                   display:"inline-flex", alignItems:"center", gap:".4rem",
//                 }}
//               >
//                 {cycle==="monthly" ? "شهري" : "سنوي"}
//                 {cycle==="yearly" && <span style={{ marginRight:".5rem", fontSize:".65rem", background: billing==="yearly"?"#08080F22":"#C9973A22", color: billing==="yearly"?"#08080F":"#C9973A", padding:".1rem .5rem", borderRadius:6, display:"inline-flex", alignItems:"center" }}>وفّر 35%</span>}
//               </button>
//             ))}
//           </div>
//         </div>
...
//           {PLANS.map((p,i)=>(
//             <div key={i} style={{
//               background: i===1 ? "linear-gradient(135deg,#1A1508,#1E1A0A)" : i===2 ? "linear-gradient(135deg,#110B1E,#160E22)" : "#0E0E1A",
//               border: `1.5px solid ${i===1?"#C9973A55":i===2?"#7C3AED55":"#1E1E2E"}`,
//               borderRadius:20, padding:"2rem", position:"relative",
//               boxShadow: i===1 ? "0 20px 60px #C9973A18" : i===2 ? "0 20px 60px #7C3AED14" : "none",
//               display:"flex", flexDirection:"column",
//             }}>
//               {p.badge && (
//                 <div style={{ position:"absolute", top:-12, right:20, padding:".25rem .875rem", borderRadius:20, background: i===2?"#7C3AED":"#C9973A", color:"#08080F", fontSize:".68rem", fontWeight:700, letterSpacing:"1px" }}>{p.badge}</div>
//               )}
//               <div style={{ marginBottom:"1.5rem" }}>
//                 <p style={{ fontSize:".8rem", color:"#8A8498", marginBottom:".5rem" }}>{p.name}</p>
//                 <div style={{ display:"flex", alignItems:"baseline", gap:".25rem" }}>
//                   <span style={{ fontFamily:"Sora,sans-serif", fontSize:"2.75rem", fontWeight:800, color: i===1?"#C9973A":i===2?"#A78BFA":"#F0EDE6" }}>
...
//                   <p style={{ fontSize:".72rem", color:"#3A3650", textDecoration:"line-through" }}>${p.monthlyPrice}/شهرياً</p>
//                 )}
//               </div>
//               <div style={{ marginBottom:"1.75rem", display:"flex", flexDirection:"column", flex:1 }}>
//                 {p.features.map((f,j)=>(
//                   <div key={j} style={{
//                     display:"flex", alignItems:"center", justifyContent:"space-between",
...
//                     minHeight:32,
//                   }}>
//                     <span style={{ fontSize:".82rem", color:"#C4BDB5", lineHeight:"32px", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>{f}</span>
//                     <span style={{ color:"#4ADE80", fontSize:".85rem", flexShrink:0, lineHeight:"32px", display:"block" }}>✓</span>
//                   </div>
//                 ))}
//                 {p.missing.map((f,j)=>(
//                   <div key={j} style={{
...
//                     minHeight:32,
//                   }}>
//                     <span style={{ fontSize:".82rem", color:"#3A3650", lineHeight:"32px", whiteSpace:"nowrap" }}>{f}</span>
//                     <span style={{ color:"#3A3650", fontSize:".85rem", flexShrink:0, lineHeight:"32px", display:"block" }}>✗</span>
//                   </div>
//                 ))}
//               </div>
//               <Link to="/register" style={{
...
//                 background: i===1?"#C9973A":i===2?"#7C3AED":"#1E1E2E",
//                 border: "none",
//                 color: i===0?"#8A8498":"#fff",
...
//           <p style={{ fontSize:".9rem", color:"#8A8498", lineHeight:1.8, marginBottom:"1.75rem" }}>انضم لمئات المشاريع العربية اللي بنت هويتها بـ ArabBrand</p>
//           <Link to="/register" style={{
...
//             {/* golden circle */}
//             <circle cx="16" cy="16" r="15" fill="url(#goldCircle)" />
//             {/* monitor icon */}
//             <rect x="8" y="9" width="16" height="11" rx="1.5" stroke="#1A1200" strokeWidth="1.4" fill="none"/>
//             <line x1="12" y1="20" x2="11" y2="24" stroke="#1A1200" strokeWidth="1.3" strokeLinecap="round"/>
//             <line x1="20" y1="20" x2="21" y2="24" stroke="#1A1200" strokeWidth="1.3" strokeLinecap="round"/>
//             <line x1="10" y1="24" x2="22" y2="24" stroke="#1A1200" strokeWidth="1.3" strokeLinecap="round"/>
//             <line x1="8" y1="17.5" x2="24" y2="17.5" stroke="#1A1200" strokeWidth="1" opacity="0.5"/>
//             {/* text ARABBRAND */}
//             <text x="36" y="21" fontFamily="Sora,sans-serif" fontSize="13" fontWeight="700" letterSpacing="2.5" fill="url(#goldText)">ARABBRAND</text>
//             <defs>
//               <radialGradient id="goldCircle" cx="35%" cy="35%" r="65%">
