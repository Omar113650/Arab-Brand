    ...
    <span style={{
      ...
      WebkitTextFillColor: "transparent",
        ...
        <div style={{ background:"#0E0E1A", border:"1px solid #1E1E2E", borderRadius:22, padding:"2.25rem", boxShadow:"0 24px 80px rgba(0,0,0,.4)" }}>
          <h1 style={{ fontFamily:"Sora,sans-serif", fontSize:"1.5rem", fontWeight:700, color:"#F0EDE6", marginBottom:".375rem" }}>مرحباً بعودتك</h1>
          <p style={{ fontSize:".82rem", color:"#8A8498", marginBottom:"1.75rem" }}>سجّل دخولك وكمّل بناء براندك</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom:"1rem" }}>
              <label style={{ display:"block", fontSize:".75rem", fontWeight:700, color:"#6B6478", letterSpacing:"1px", textTransform:"uppercase", marginBottom:".5rem" }}>البريد الإلكتروني</label>
              <input
            ...
            <div style={{ marginBottom:"1.5rem" }}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:".5rem" }}>
                <label style={{ fontSize:".75rem", fontWeight:700, color:"#6B6478", letterSpacing:"1px", textTransform:"uppercase" }}>كلمة المرور</label>
                <a href="#" style={{ fontSize:".72rem", color:"#C9973A", textDecoration:"none" }}>نسيت كلمة المرور؟</a>
              </div>
              <input
