...
//   launchPlan: any;
//   swot: any;
//   ageSegments: any;        // شرائح السوق العمرية ← جديد
...
//     launchPlan:    { type: Schema.Types.Mixed },
//     swot:          { type: Schema.Types.Mixed },
//     ageSegments:   { type: Schema.Types.Mixed },   // ← جديد
//     // ── Legacy / future fields ──
//     launchPlanLegacy: { type: Schema.Types.Mixed },
//     buyerPersona:  { type: Schema.Types.Mixed },
//     adScripts:     { type: Schema.Types.Mixed },
...
const resultSchema = new Schema<IResult>(
  {
    ...
    businessOverview: { type: Schema.Types.Mixed, default: {} }, // ← جديد
    agePreferences:   { type: Schema.Types.Mixed, default: {} }, // ← جديد
    faq:              { type: Schema.Types.Mixed, default: {} }, // ← جديد
    launchPlanLegacy: { type: Schema.Types.Mixed },
    buyerPersona:  { type: Schema.Types.Mixed },
    adScripts:     { type: Schema.Types.Mixed },
    emailCampaign: { type: Schema.Types.Mixed },
