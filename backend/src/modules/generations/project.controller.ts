...
//         // Run all missing ones in parallel
//         const backfillTasks = await Promise.allSettled([
//           needsCompetitors
//             ? generateCompetitorsOnly(brandCtx).then(
//                 (r) => r && (updates.competitors = r),
...
// /* ── Regenerate Single Section (paid - 0.5 credit logic or free, your choice) ── */
// export const regenerateSection = asyncHandler(
//   async (req: Request, res: Response) => {
//     const userId = req.session.userId!;
//     const section = req.params.section as string; // objections | productFocus | launchPlan | swot
